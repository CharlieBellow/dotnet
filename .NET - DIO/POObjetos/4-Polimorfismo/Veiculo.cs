namespace POObjetos.4_Polimosfismo
{
    public abstract class Veiculo : IVeiculo //aqui estamos dizendo que essa classe está herdando de IVeiculo
    {
        ...
        //adicinando métodos
        public virtual void ligar() //o virtual escrito nessa superclasse dá a possibilidade de sobrescrever a classe, e aí podemos usar o overrride para sobrescrever.
        {
